...
CanCommunication_Message T_INV_FL_AMK_Setpoints1_log;
CanCommunication_Message T_INV_RL_AMK_Setpoints1_log;
CanCommunication_Message T_INV_RR_AMK_Setpoints1_log;
CanCommunication_Message T_INV_FR_AMK_Setpoints1_log;
...
static void setTransmitMessageLog(uint32_t ID, CanCommunication_Message *Tm,uint8 node);
...
//		CanCommunication_setMessageData(INV_RL_AMK_Actual_Values1.RecievedData[0],
//		    INV_RL_AMK_Actual_Values1.RecievedData[1], &T_INV_RL_AMK_Actual_Values1_log);
...
//		CanCommunication_setMessageData(INV_RL_AMK_Actual_Values2.RecievedData[0],
//		    INV_RL_AMK_Actual_Values2.RecievedData[1], &T_INV_RL_AMK_Actual_Values2_log);
...
//		CanCommunication_setMessageData(INV_RR_AMK_Actual_Values1.RecievedData[0],
//		    INV_RR_AMK_Actual_Values1.RecievedData[1], &T_INV_RR_AMK_Actual_Values1_log);
...
//		CanCommunication_setMessageData(INV_RR_AMK_Actual_Values2.RecievedData[0],
//		    INV_RR_AMK_Actual_Values2.RecievedData[1], &T_INV_RR_AMK_Actual_Values2_log);
...
//	AmkInverter_can_write(&INV_FL_AMK_Setpoint1, T_INV_FL_AMK_Setpoints1_log, Value1);
//	AmkInverter_can_write(&INV_FR_AMK_Setpoint1, T_INV_FR_AMK_Setpoints1_log, Value2);
...
//	AmkInverter_can_write(&INV_RR_AMK_Setpoint1, T_INV_RR_AMK_Setpoints1_log, Value1);
//	AmkInverter_can_write(&INV_RL_AMK_Setpoint1, T_INV_RL_AMK_Setpoints1_log, Value2);
}
...
void AMKInverter_log_init(void) {

	// Init CAN msg of AMK_Setpoints1
	setTransmitMessageLog((uint32_t)Inverter_FL.ID_AMK_Set + (uint32_t)0x275000, &T_INV_FL_AMK_Setpoints1_log, 0);
	setTransmitMessageLog((uint32_t)Inverter_RL.ID_AMK_Set + (uint32_t)0x275000, &T_INV_RL_AMK_Setpoints1_log, 0);
	setTransmitMessageLog((uint32_t)Inverter_FR.ID_AMK_Set + (uint32_t)0x275000, &T_INV_FR_AMK_Setpoints1_log, 0);
	setTransmitMessageLog((uint32_t)Inverter_RR.ID_AMK_Set + (uint32_t)0x275000, &T_INV_RR_AMK_Setpoints1_log, 0);
	...
	setTransmitMessageLog((uint32_t)Inverter_FR.ID_AMK_Ac1 + (uint32_t)0x275000, &T_INV_FR_AMK_Actual_Values1_log, 0);
	setTransmitMessageLog((uint32_t)Inverter_RR.ID_AMK_Ac1 + (uint32_t)0x275000, &T_INV_RR_AMK_Actual_Values1_log, 0);

	// Init CAN msg of AMK_Actual_Values1
	setTransmitMessageLog((uint32_t)Inverter_FL.ID_AMK_Ac2 + (uint32_t)0x275000, &T_INV_FL_AMK_Actual_Values2_log, 0);
